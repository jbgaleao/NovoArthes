...
namespace Arthes.WEB.Controllers
{
    public class FabricantesController : Controller
    {
        ...
        public FabricantesController(ArthesContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Fabricante != null ? 
                          ...
                          Problem("Entity set 'ArthesContext.Fabricante'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ArthesContext.Fabricante'  is null.");
            }
            var fabricante = await _context.Fabricante.FindAsync(id);
            if (fabricante != null)
            {
